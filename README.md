...
This configures an OS X Mavericks workstation for Ruby development using [soloist](https://github.com/mkocher/soloist) and [librarian-chef](https://github.com/applicationsonline/librarian-chef).
...
### 3. Clone this project
    ...
    git clone https://github.com/neo/sprout-wrap.git
    cd sprout-wrap
